...
**IMPORTANT**: The library's import path is based on its original location under `github.com/uber`. Do not try to import it as `github.com/jaegertracing`, it will not compile. We might revisit this in the next major release.
  * :white_check_mark: `import "github.com/antgrocm/jaeger-client-go"`
...
```toml
[[constraint]]
  name = "github.com/antgrocm/jaeger-client-go"
  version = "2.17"
```
...
```shell
go get -u github.com/antgrocm/jaeger-client-go/
cd $GOPATH/src/github.com/antgrocm/jaeger-client-go/
...
See tracer initialization examples in [godoc](https://godoc.org/github.com/antgrocm/jaeger-client-go/config#pkg-examples)
and [config/example_test.go](./config/example_test.go).

### Environment variables

The tracer can be initialized with values coming from environment variables, if it is
[built from a config](https://pkg.go.dev/github.com/antgrocm/jaeger-client-go/config?tab=doc#Configuration.NewTracer)
that was created via [FromEnv()](https://pkg.go.dev/github.com/antgrocm/jaeger-client-go/config?tab=doc#FromEnv).
...
[doc-img]: https://godoc.org/github.com/antgrocm/jaeger-client-go?status.svg
[doc]: https://godoc.org/github.com/antgrocm/jaeger-client-go
